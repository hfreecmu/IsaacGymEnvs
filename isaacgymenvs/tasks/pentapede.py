...
class Pentapede(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        self.cfg["env"]["numObservations"] = 66#48#TODO why 75 now?
        #self.cfg["env"]["numActions"] = 12
        self.cfg["env"]["numActions"] = len(self.named_default_joint_angles)
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        asset_file = "urdf/pentapede/urdf/pentapede.urdf" #TODO or do we want anymal_minimal?
        ...
        for i in range(self.num_envs):
            ...
            anymal_handle = self.gym.create_actor(env_ptr, anymal_asset, start_pose, "pentapede", i, 1, 0)
